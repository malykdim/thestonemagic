        ...
        <GalleryContext.Consumer>
            {values => 
                <fieldset>
                    ...
                    <input  onClick={values.checkBoxHandler} type="checkbox" id="mountain crystal" name="mountain crystal" value="Mountain crystal" className="material"/>
                    ...
                    <input  onClick={values.checkBoxHandler} type="checkbox" id="tiger's eye" name="tiger's eye" value="Tiger's eye" className="material"/>
